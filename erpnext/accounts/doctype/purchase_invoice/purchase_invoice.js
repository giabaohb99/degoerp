...
erpnext.accounts.PurchaseInvoice = class PurchaseInvoice extends erpnext.buying.BuyingController {
	...
	refresh(doc) {
		...
		if (this.frm.doc.grand_total !== undefined && this.frm.doc.outstanding_amount !== undefined) {
			this.frm.doc.custom_paid_amount = flt(this.frm.doc.grand_total) - flt(this.frm.doc.outstanding_amount);
